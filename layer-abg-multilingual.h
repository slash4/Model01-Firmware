...
KEYMAP_STACKED
  (___,                       Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   Key_Backtick,              Key_Q, Key_W, Key_E, Key_R, Key_T, MOD_L_MIDDLE,
   Key_Backslash,             Key_A, Key_S, Key_D, Key_F, Key_G,
   Key_NonUsBackslashAndPipe, Key_Z, Key_X, Key_C, Key_V, Key_B, MOD_L_BOTTOM,
   MOD_L_THUMB_0, MOD_L_THUMB_1, MOD_L_THUMB_2, MOD_L_THUMB_3,
   MOD_L_PALM,

   Key_Minus,     Key_6, Key_7, Key_8,     Key_9,      Key_0,         Key_Equals,
   MOD_R_MIDDLE,  Key_Y, Key_U, Key_I,     Key_O,      Key_P,         Key_LeftBracket,
